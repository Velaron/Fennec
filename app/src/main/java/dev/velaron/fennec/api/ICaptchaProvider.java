...
public interface ICaptchaProvider {
     ...
     * После выполнения этого метода следует периодически проверять {@link dev.velaron.fennec.api.ICaptchaProvider#lookupCode}
     * @param sid код капчи
     * @param captcha капча
     */
     ...
     * с помощью метода {@link dev.velaron.fennec.api.ICaptchaProvider#notifyThatCaptchaEntryActive}
