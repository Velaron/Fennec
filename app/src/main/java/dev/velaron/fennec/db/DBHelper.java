...
import dev.velaron.fennec.crypt.ver.Version;
import dev.velaron.fennec.db.column.AttachmentsColumns;
import dev.velaron.fennec.db.column.CommentsAttachmentsColumns;
import dev.velaron.fennec.db.column.CommentsColumns;
import dev.velaron.fennec.db.column.CountriesColumns;
import dev.velaron.fennec.db.column.DialogsColumns;
import dev.velaron.fennec.db.column.DocColumns;
import dev.velaron.fennec.db.column.FaveLinksColumns;
import dev.velaron.fennec.db.column.FavePageColumns;
import dev.velaron.fennec.db.column.FavePhotosColumns;
import dev.velaron.fennec.db.column.FavePostsColumns;
import dev.velaron.fennec.db.column.FaveVideosColumns;
import dev.velaron.fennec.db.column.FeedListsColumns;
import dev.velaron.fennec.db.column.FriendListsColumns;
import dev.velaron.fennec.db.column.GroupColumns;
import dev.velaron.fennec.db.column.GroupContactsColumns;
import dev.velaron.fennec.db.column.GroupLinksColumns;
import dev.velaron.fennec.db.column.GroupsDetColumns;
import dev.velaron.fennec.db.column.KeyColumns;
import dev.velaron.fennec.db.column.MessageColumns;
import dev.velaron.fennec.db.column.NewsColumns;
import dev.velaron.fennec.db.column.NotificationColumns;
import dev.velaron.fennec.db.column.PeersColumns;
import dev.velaron.fennec.db.column.PhotoAlbumsColumns;
import dev.velaron.fennec.db.column.PhotosColumns;
import dev.velaron.fennec.db.column.PostAttachmentsColumns;
import dev.velaron.fennec.db.column.PostsColumns;
import dev.velaron.fennec.db.column.RelationshipColumns;
import dev.velaron.fennec.db.column.StikerSetColumns;
import dev.velaron.fennec.db.column.TopicsColumns;
import dev.velaron.fennec.db.column.UserCareerColumns;
import dev.velaron.fennec.db.column.UserColumns;
import dev.velaron.fennec.db.column.UsersDetColumns;
