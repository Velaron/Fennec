...
import static dev.velaron.fennec.db.column.VideoColumns.ACCESS_KEY;
import static dev.velaron.fennec.db.column.VideoColumns.ADDING_DATE;
import static dev.velaron.fennec.db.column.VideoColumns.ALBUM_ID;
import static dev.velaron.fennec.db.column.VideoColumns.CAN_COMENT;
import static dev.velaron.fennec.db.column.VideoColumns.CAN_REPOST;
import static dev.velaron.fennec.db.column.VideoColumns.COMMENTS;
import static dev.velaron.fennec.db.column.VideoColumns.DATE;
import static dev.velaron.fennec.db.column.VideoColumns.DESCRIPTION;
import static dev.velaron.fennec.db.column.VideoColumns.DURATION;
import static dev.velaron.fennec.db.column.VideoColumns.EXTERNAL;
import static dev.velaron.fennec.db.column.VideoColumns.HLS;
import static dev.velaron.fennec.db.column.VideoColumns.LIKES;
import static dev.velaron.fennec.db.column.VideoColumns.LINK;
import static dev.velaron.fennec.db.column.VideoColumns.LIVE;
import static dev.velaron.fennec.db.column.VideoColumns.MP4_1080;
import static dev.velaron.fennec.db.column.VideoColumns.MP4_240;
import static dev.velaron.fennec.db.column.VideoColumns.MP4_360;
import static dev.velaron.fennec.db.column.VideoColumns.MP4_480;
import static dev.velaron.fennec.db.column.VideoColumns.MP4_720;
import static dev.velaron.fennec.db.column.VideoColumns.ORIGINAL_OWNER_ID;
import static dev.velaron.fennec.db.column.VideoColumns.OWNER_ID;
import static dev.velaron.fennec.db.column.VideoColumns.PHOTO_130;
import static dev.velaron.fennec.db.column.VideoColumns.PHOTO_320;
import static dev.velaron.fennec.db.column.VideoColumns.PHOTO_800;
import static dev.velaron.fennec.db.column.VideoColumns.PLAYER;
import static dev.velaron.fennec.db.column.VideoColumns.PRIVACY_COMMENT;
import static dev.velaron.fennec.db.column.VideoColumns.PRIVACY_VIEW;
import static dev.velaron.fennec.db.column.VideoColumns.REPEAT;
import static dev.velaron.fennec.db.column.VideoColumns.TITLE;
import static dev.velaron.fennec.db.column.VideoColumns.USER_LIKES;
import static dev.velaron.fennec.db.column.VideoColumns.VIDEO_ID;
import static dev.velaron.fennec.db.column.VideoColumns.VIEWS;
...
import dev.velaron.fennec.db.column.VideoColumns;
